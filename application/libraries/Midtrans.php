...
class Midtrans {
    ...
    */
	 ...
	 * @param mixed[] $data_hash
	 */
	public static function post($url, $server_key, $data_hash, $notifurl)
	{
	    return self::remoteCall($url, $server_key, $data_hash, true, $notifurl);
	}
	 ...
	 * @param bool    $post
	 */
    public static function remoteCall($url, $server_key, $data_hash, $post = true, $notifurl = 'http://103.89.1.214/emoneycourseapi/index.php/api/snap/notification')
    {	
  ...
  public static function getSnapToken($params, $notifurl = 'http://103.89.1.214/emoneycourseapi/index.php/api/snap/notification')
  {
